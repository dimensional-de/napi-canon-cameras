...
export class ImageQuality implements PropertyValue {
     ...
     * @enum {number}
     */
     static readonly Size: {[label: string]: number} = {"Large":0,"Middle":1,"Middle1":5,"Middle2":6,"Small":2,"Small1":14,"Small2":15,"Small3":16,"Unknown":-1};
    /**
     * @readonly
     * @enum {number}
     */
     static readonly CompressionQuality: {[label: string]: number} = {"Fine":3,"Lossless":4,"Normal":2,"SuperFine":5,"Unknown":-1};
